<html lang="pt-br">
    ...
    <body>
		<div class="conteudo">
			...
			<p><a class="HOME" href="relatorio_fornecedor.php">Emitir Relatório</a></p>
				...
				<tbody>
					...
					<tr>
						...
						<td>
							...
							<a class="HOME" href="deleteFornecedor.php?id=<?php echo $fornecedor['idFornecedor'] ?>" onclick="return confirm('Tem certeza que deseja excluir?');">Excluir</a>
						</td>
					</tr>
				<?php endwhile; ?>
				</tbody>
