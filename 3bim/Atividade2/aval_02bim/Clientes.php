...
<head>
	...
	<body>
		<div class="conteudo">
			...
			<p><a class="HOME" href="relatorio_cliente.php">Emitir Relatório</a></p>
			<p><a id="pdf" class="HOME" href="gerar_mala_cliente.php">Gerar Mala Direta</a></p>
				...
				<tbody>
					...
					<tr>
						...
						<td>
							...
							<a class="HOME"href="deleteCliente.php?id=<?php echo $cliente['idCliente'] ?>" onclick="return confirm('Tem certeza que deseja deletar?');">Excluir</a>
						</td>
					</tr>
				<?php endwhile; ?>
				</tbody>
